...
-- Tiempo de generación: 19-11-2018 a las 22:58:10
...
SELECT o.idOrden,o.NumOrden,ma.Descripcion,o.Lote,o.Kilos,o.NumConos,o.Estado_idEstado,e.nombreEstado,DATE_FORMAT(o.fechaRegistro,"%d/%m/%Y") as fechaRegistro FROM orden o INNER JOIN estado e ON e.idEstado=o.Estado_idEstado INNER JOIN material ma On ma.idMaterial=o.Material_idMaterial;
...
(1, 1, 'admin', '$2a$08$RCuzW/8g2Lg4QMNCfmsa/uKp33rvDmdWrC.P40DOECJlMtPu16NMW', 'Administrador', '2018-09-29 14:03:44', '::1', '2018-11-19 11:37:07');
...
(1, 'Nº 0001', 3, '12', '12.00', '12.00', '2018-11-19 17:22:52', 10),
(2, 'Nº 0002', 3, '12', '12.00', '12.00', '2018-11-19 17:23:44', 10),
(3, 'Nº 0002', 3, '12', '12.00', '12.00', '2018-11-19 17:23:52', 10),
(4, 'Nº 0004', 3, '12', '12.00', '12.00', '2018-11-19 17:24:48', 10);
