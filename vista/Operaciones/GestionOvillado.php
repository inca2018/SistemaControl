            ...
            <div class="card card-default">
               <div class="card-body">
                <input type="hidden" id="idOrden" value="<?php echo $_POST["idOrden"];?>">
             			 ...
             			 <div class="row">
                            <div class="col-md-2 ">
                                <button class="btn btn-info btn-block btn-sm" onclick="Volver();"><i class="fas fa-chevron-left mr-1"></i>Volver a lista Enviados</button>
                            </div>
                            <div class="col-md-2 offset-8">
                                <button class="btn btn-success btn-block btn-sm" onclick="NuevoOvillado();"><i class="fa fa-plus fa-lg mr-2"></i> Nuevo Orden de Ovillado</button>
                            </div>
                        </div>
